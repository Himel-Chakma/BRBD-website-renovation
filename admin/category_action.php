...
if(isset($_POST["action"])) {
    ...
    if($_POST["action"] == 'fetch') {
		...
		$main_query = "SELECT * FROM category ";
    ...
    if($_POST["action"] == 'Add') {
		...
		$object->query = "SELECT * FROM category WHERE category_name = :category";
		...
		else
		{
			...
			$object->query = "INSERT INTO category(category_name, category_status)VALUES(:category, :category_status)";
