              ...
              <div class="container m-0 p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarNav2">
                  <ul class="navbar-nav d-flex flex-column custom-style m-0 p-0">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active2" href="student_profile.php"><i class="fa-solid fa-user me-2"></i> My Profile</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="container m-0 p-0">
              ...
              <?php
                ...
                foreach($result as $row)
                {
                  ...
                  $date = new DateTime($registered_on);
                  $registered_on = $date->format('d F Y');
              ...
              ?>
              <div class="row">
                <div class="col-md-3 mb-3">Registration Date</div>
                <div class="col-md-9 mb-3 fw-bold"><?php echo $registered_on; ?></div>
              </div>
              <div class="row">
                <div class="col-md-3 mb-3">First Name</div>
                <div class="col-md-9 mb-3 fw-bold"><?php echo $student_first_name; ?></div>
              </div>
              <div class="row">
                <div class="col-md-3 mb-3">Last Name</div>
                <div class="col-md-9 mb-3 fw-bold"><?php echo $student_last_name; ?></div>
              </div>
              <div class="row">
                <div class="col-md-3 mb-3">Username</div>
                <div class="col-md-9 mb-3 fw-bold"><?php echo $student_user_name; ?></div>
              </div>
              <div class="row">
                <div class="col-md-3 mb-3">Email</div>
                <div class="col-md-9 mb-3 fw-bold"><?php echo $student_email; ?></div>
              </div>
              <div class="row">
                <div class="col-md-3 mb-3">Phone Number</div>
                <div class="col-md-9 mb-3 fw-bold"><?php echo $student_mobile; ?></div>
              </div>
              <div class="row">
                <div class="col-md-3 mb-3">Skill/Occupation</div>
                <div class="col-md-9 mb-3 fw-bold"><?php echo $student_skill; ?></div>
              </div>
              <div class="row">
                <div class="col-md-3 mb-3">Biography</div>
                <div class="col-md-9 mb-3 fw-bold"><?php echo $student_biography; ?></div>
              </div>
            </div>
        </div>
    </div>
